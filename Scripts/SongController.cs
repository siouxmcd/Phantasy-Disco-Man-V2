...
public class SongController : MonoBehaviour {
    ...
    SpectrumProcessing realTimeSpectralFluxAnalyzer;
    ...
    SpectrumProcessing preProcessedSpectralFluxAnalyzer;
    public PlotController preProcessedPlotController;
    ...
    void Start () {
        ...
        if (realTimeSamples)
        {
            ...
            realTimeSpectralFluxAnalyzer = new SpectrumProcessing();
        ...
        if (preProcessSamples)
        {
            ...
            preProcessedSpectralFluxAnalyzer = new SpectrumProcessing();
